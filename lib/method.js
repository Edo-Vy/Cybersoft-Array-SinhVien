...
/** Hàm nhận vào 1 arrNumber ( mảng số nguyên ) trả ra mảng đó sắp xếp tắng dần
 * 
 * @param {*} arrNumber arrNumber là 1 mảng số nguyên chưa sắp xếp
 * @returns returns : kết quả trả về là 1 mảng số nguyên đã được sắp xếp
 */

function sapXepTangDanSo(arrNumber) { // input arr[4,6,7,8,9,10]
